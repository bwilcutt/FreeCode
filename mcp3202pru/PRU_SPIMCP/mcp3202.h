...
#define MCP_MODE_CH0 13 // 1101b  Start = 1. SGL = 1, ODD = 0, MSBF = 1
#define MCP_MODE_CH1 15 // 1111b  Start = 1, SGL = 1. ODD = 1, MSBF = 1
...
#define DEFAULT_MOSIBITSOUT_CH0	(MCP_MODE_CH0)
